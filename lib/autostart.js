...
function tryLaunch() {
    ...
    for (const rule of rules()) {
        ...
        // Цель — чтобы у приложения было ВИДИМОЕ окно. Если есть — оставим.
        ...
        // Окна нет:
        //   - STOPPED → стартуем процесс через .desktop launch.
        //   - RUNNING без окна (Telegram -autostart в трее, и т.п.) →
        //     activate(), он умеет «вытащить» окно из трея.
        try {
