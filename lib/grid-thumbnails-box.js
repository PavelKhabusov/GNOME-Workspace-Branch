...
class GridThumbnailsBox extends ThumbnailsBox {
    _init(scrollAdjustment, monitorIndex, topology, ops) {
        super._init(scrollAdjustment, monitorIndex);
        this._topology = topology;
        this._ops = ops;
        this._dropMode = 'none'; // 'none' | 'col-up' | 'col-down' | 'main-end'
        this._dropCol  = -1;
    ...
    handleDragOver(source, actor, x, y, time) {
        ...
        // 2) main-end — расширение главного ряда новой колонкой справа.
        // Только в конце ряда чтобы не сдвигать индексы AMW.
